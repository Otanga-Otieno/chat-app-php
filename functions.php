...
function get_chats($user1, $user2) {
    ...
    foreach($array as $row) {
        ...
        if($sender == $user1) {
            echo "
                <span class='rounded p-1 m-2' style='display: inline-block; justify-content: flex-end; background-color: #dcf8c6;'>".$message."</span><br>
            ";
        } else {
            echo "
                <span class='rounded p-1 m-2' style='display: inline-block; justify-content: flex-start; background-color:  #fff5c4;'>".$message."</span><br>
            ";
        }
    }
