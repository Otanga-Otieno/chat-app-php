...
function get_chats($user1, $user2) {
    ...
    foreach($array as $row) {
        ...
        if($sender == $user1) {
            echo "
                <span class='rounded p-1 m-2' style='display: block; width: fit-content; margin-left: auto; margin-right: 0; background-color: #dcf8c6;'>".$message."</span><br>
            ";
        } else {
            echo "
                <span class='rounded p-1 m-2' style='display: block; width: fit-content;  margin-right: auto; margin-left: 0; background-color:  #fff5c4;'>".$message."</span><br>
            ";
        }
    }
